...
void motor_output()
{
  ...
  if (motorArmed == 1) {   
    ...
    rightMotor = constrain(throttle - control_roll - control_pitch + control_yaw, minThrottle, 2000);
    leftMotor = constrain(throttle + control_roll + control_pitch + control_yaw, minThrottle, 2000);
